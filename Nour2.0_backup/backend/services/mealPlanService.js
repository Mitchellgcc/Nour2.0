...
function adjustMealsForHealthGoals(meals, healthGoal) {
  return meals.map(meal => {
    if (healthGoal.includes('weight loss')) {
    ...
    } else if (healthGoal.includes('muscle gain')) {
    ...
    // Add further conditions for other health goals
...
async function generateMealPlan(userId) {
  try {
    ...
    // Include hydration goals and preferred meal types in the plan
